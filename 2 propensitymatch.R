...
sagesites <- read.csv("formatteddata/randomsites_final.csv")
...
saveRDS(probtreatbefore, 
        file = "modelfits/treatmentprob_beforePSM_final.rda")
  


### b) Complete Propensity Score Matching: ######

#Set caliper to 0.2*Std deviation of the propensity scores:
...
saveRDS(probtreatafter, 
        file = "modelfits/treatmentprob_afterPSM_final.rda")
...
write.csv(matchdat, "formatteddata/matcheddata_final.csv")
