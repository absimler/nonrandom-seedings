...
saveRDS(treatmenteff.nomatch, 
        file = "modelfits/treatmenteff.nomatch_feb28.rda")
...
saveRDS(treatmenteff.covars, 
        file = "modelfits/treatmenteff.covarsfireid_feb28.rda")
...
saveRDS(treatmenteff.match, 
        file = "modelfits/treatmenteff.match_feb28.rda")
...
saveRDS(treatmenteff.did, 
        file = "modelfits/treatmenteff.did.sitefireid_feb28.rda")
...
saveRDS(treatmenteff.panel,
        file = "modelfits/treatmenteff.panelsitefireid.rda")
