...
treatmenteff.nomatch <- readRDS("modelfits/treatmenteff.nomatch_final.rda")
treatmenteff.covars <- readRDS("modelfits/treatmenteff.covarsfireid_final.rda")
treatmenteff.match <- readRDS("modelfits/treatmenteff.match_final.rda")
treatmenteff.did <- readRDS( "modelfits/treatmenteff.did.sitefireid_final.rda")
treatmenteff.panel <- readRDS( "modelfits/treatmenteff.panelsitefireid_final.rda")
did.environ <- readRDS("modelfits/treatmenteff.did.environ_mar2.rda")
...
write.csv(ate.preds, "formatteddata/fig4a_source.csv")
...
#####  Environment*Treatment Marginal effects plots #######
mytheme <-  theme_bw() + 
...
write.csv(preds.ppt, "sourcefigs/fig5a.csv")
...
probtreatbefore <- readRDS(file = "modelfits/treatmentprob_beforePSM_final.rda")
...
write.csv(preds.temp, "sourcefigs/fig5c.csv")
...
write.csv(preds.treat, "sourcefigs/fig5d.csv")
